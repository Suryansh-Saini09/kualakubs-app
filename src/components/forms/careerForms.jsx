            ...
            <form className="row g-3" onSubmit={handleSubmit}>
                ...
                <div className="col-12">
                    <h5 className="form-section-title">
                        <i className="bi bi-person-badge text-primary"></i> Personal Information
                    </h5>
                </div>
                ...
                <div className="col-12 mt-4">
                    <h5 className="form-section-title">
                        <i className="bi bi-geo-alt-fill text-success"></i> Address Details
                    </h5>
                </div>
                ...
                <div className="col-12 mt-4">
                    <h5 className="form-section-title">
                        <i className="bi bi-briefcase-fill text-warning"></i> Employment Details
                    </h5>
                </div>
                ...
                <div className="col-12 mt-4">
                    <h5 className="form-section-title">
                        <i className="bi bi-currency-rupee text-danger"></i> Salary & Submission Details
                    </h5>
                </div>
                ...
                <div className="col-md-3">
                    ...
                    <input type="file" className="file-upload-input" accept=".pdf,.doc,.docx" onChange={handleFile} required />
                </div>

                {/* ================= SUBMIT ================= */}
                <div className="col-12 text-center mt-5">
                    <button className="career-btn-gold border-0 px-5" type="submit" disabled={loading}>
